...
class TextToSpeechRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets language_code
     *
     * @param string $language_code ISO 639-3 three-letter language code (e.g. eng, spa, fra, hin, ita, jpn, por, zho). Default is eng (English).
     *
     * @return $this
     */
     ...
     * Sets gender
     *
     * @param string $gender Voice gender: Male or Female. Default is Female. Note: Male is not available for French and Chinese.
     *
     * @return $this
     */

...
class SpeakApi
{
    ...
    /**
     * Operation speakTextToSpeech
     *
     * Perform text-to-speech on a string
     *
     * @param  \Swagger\Client\Model\TextToSpeechRequest $req_config String input request (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function speakTextToSpeech($req_config)
    {
        list($response) = $this->speakTextToSpeechWithHttpInfo($req_config);
        return $response;
    }

    /**
     * Operation speakTextToSpeechWithHttpInfo
     *
     * Perform text-to-speech on a string
     *
     * @param  \Swagger\Client\Model\TextToSpeechRequest $req_config String input request (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function speakTextToSpeechWithHttpInfo($req_config)
    {
        $returnType = 'object';
        $request = $this->speakTextToSpeechRequest($req_config);
    ...
    /**
     * Operation speakTextToSpeechAsync
     *
     * Perform text-to-speech on a string
     *
     * @param  \Swagger\Client\Model\TextToSpeechRequest $req_config String input request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function speakTextToSpeechAsync($req_config)
    {
        return $this->speakTextToSpeechAsyncWithHttpInfo($req_config)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation speakTextToSpeechAsyncWithHttpInfo
     *
     * Perform text-to-speech on a string
     *
     * @param  \Swagger\Client\Model\TextToSpeechRequest $req_config String input request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function speakTextToSpeechAsyncWithHttpInfo($req_config)
    {
        $returnType = 'object';
        $request = $this->speakTextToSpeechRequest($req_config);
    ...
    /**
     * Create request for operation 'speakTextToSpeech'
     *
     * @param  \Swagger\Client\Model\TextToSpeechRequest $req_config String input request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function speakTextToSpeechRequest($req_config)
    {
        // verify the required parameter 'req_config' is set
        if ($req_config === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $req_config when calling speakTextToSpeech'
            );
        }
